...
import { getContactInfo, getPhoneLink, getWhatsAppLink } from '../data/contactData';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3.5">
              <div className="bg-white rounded-xl px-2.5 py-1.5 flex items-center justify-center shadow-sm">
                <img
                  src={logoImg}
            ...
            <div className="flex gap-2">
              ...
              <SocialIcon
                href={ci.instagram || "https://instagram.com"}
          ...
          <div className="md:justify-self-end">
            ...
            <div className="space-y-3">
              {[
                { icon: Phone,  text: ci.primaryPhone,  href: getPhoneLink(ci.primaryPhone) },
                ...(ci.secondaryPhone ? [{ icon: Phone, text: ci.secondaryPhone + ' (Emergency)', href: getPhoneLink(ci.secondaryPhone) }] : []),
                { icon: Mail,   text: ci.email, href: `mailto:${ci.email}` },
                { icon: MapPin, text: `${ci.addressLine2 ? ci.addressLine2 + ', ' : ''}${ci.city} – ${ci.pincode}`, href: null },
